...
if __name__ == "__main__":
    ...
    ax.set_xlabel('Year')
    ax.set_title('Population in USA (2020-2100)')
    ax.set_ybound(lower=0.3, upper=0.5)
    ax.set_xticks(x)
...
# https://www.un.org/en/development/desa/population/publications/pdf/trends/WorldPop2300final.pdf
# world = 9.22 bn
# usa = 534 mn
